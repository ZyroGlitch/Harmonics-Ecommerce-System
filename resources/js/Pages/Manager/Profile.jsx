...
function Profile({ manager }) {
    ...
    const {
        ...
        put: postUserInfo, processing: processingUserInfo,
    ...
    function submitUserInfo(e) {
        e.preventDefault();
        postUserInfo(route('manager.updateManagerInfo'), {
            onSuccess() {
                resetUserInfo();
            }
        });
    ...
    // Form for manager profile image
    const {
        data: manager_profile, setData: setmanager_profile,
        post: postmanager, processing: processmanager,
        errors: errormanager, reset: resetmanager
    } = useForm({
        profile: '',
    });
    ...
    const handleImageChange = (e) => {
        ...
        setmanager_profile('profile', file); // Set the file to the Inertia form
    ...
    function submitProfileImage(e) {
        e.preventDefault();
        postmanager(route('manager.updateManagerProfile'), {
            onSuccess() {
                resetmanager();

                setmanager_profile('profile', null);
    ...
    function cancelUpdateImage(e) {
        ...
        setmanager_profile('profile', `${auth.user ? `/storage/${auth.user.profile}` : null}`);
    ...
    function submitUpdatePassword(e) {
        e.preventDefault();
        postUserPassword(route('manager.updateManagerPassword'), {
            onSuccess() {
                resetUserPassword();
            }
        });
